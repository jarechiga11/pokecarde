...
Instructions2: ; 199d
	...
	db "Sapphire to trigger an event.\0"

DeliveryInProcess: ; 1a0d
	db "Event delivery in Process...\0"

FossilDelivered: ; 1a2f
	db "Event delivered!\n"
	db "\n"
...
Start: ; 1ae2
	...
	SetBackgroundPalette 16, $0040, FossilPalette
...
INCLUDE "../common/transfer_data.asm"
	...
	DrawText RegionHandlePtr, FossilDelivered, 8, 4
